...
from pysme.persistence import IPersist, load
...
class Parameters(Collection):
    ...
    _fields = Collection._fields + [
        ...
        ("vmin", 0, abs, this, "float: micro turbulence in km/s"),
        ("vmax", 0, abs, this, "float: macro turbulence in km/s"),
...
# filename = "./examples/sun.sme"
# sme = SME_Structure.load(filename)

filename = "./examples/sun_6440_grid.inp"
sme = SME_Structure.load(filename)
